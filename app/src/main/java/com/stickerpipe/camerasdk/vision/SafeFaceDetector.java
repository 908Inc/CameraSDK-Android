...
/**
 * This is a workaround for a bug in the face1 detector, in which either very small images (i.e.,
 * most images with dimension < 147) and very thin images can cause a crash in the native face1
 * detection code.  This will add padding to such images before face1 detection in order to avoid
 * this issue.<p>
 *
...
public class SafeFaceDetector extends Detector<Face> {
    ...
    /**
     * Creates a safe face1 detector to wrap and protect an underlying face1 detector from images that
     * trigger the face1 detector bug.
     */
    ...
    /**
     * Determines whether the supplied image may cause a problem with the underlying face1 detector.
     ...
     * increase the size to avoid the bug in the underlying face1 detector.
     */
